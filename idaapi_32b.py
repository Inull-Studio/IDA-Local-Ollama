...
# 初始化大模型客户端
client_1 = Client(host='http://192.168.1.240:11434')  # 第一个智能体
client_2 = Client(host='http://192.168.1.240:11434')  # 第二个智能体

# 定义模型
model_name_1 = 'qwen2.5:32b'  # 第一个智能体使用的模型
model_name_2 = 'qwen2.5:32b'  # 第二个智能体使用的模型
